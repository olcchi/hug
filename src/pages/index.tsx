          ...
          <section className='flex flex-col items-center '>
            <section className='flex flex-col items-center justify-center mt-40 mb-5 w-4/5 md:1/2 lg:w-3/5 xl:w-1/3 transition-all'>
              ...
              {!loading ? (<section className='w-full mt-3 flex transition-all'>
                <input
                  className='flex-grow flex-shrink p-4 h-12 rounded text-white bg-neutral-800 hover:opacity-80 focus:outline-none  focus:border-neutral-600 focus:ring-2 focus:ring-neutral-600 transition-all'
                  type="text"
                  placeholder={'请给我一些安慰...'}
                  value={desc}
                ...
                <button className='flex-shrink text-xs md:text-base w-20 md:w-24 h-12 rounded text-white hover:opacity-80 bg-neutral-800  font-bold transition-all'
                  ...
                  <div
                  className='flex items-center justify-center relative mt-3 w-full text-xs md:text-base h-12 rounded text-white  bg-neutral-800  font-bold transition-all animate-pulse'
                  >
                    生成中...
                     <button className='bg-neutral-700 h-8 w-20 rounded text-xs absolute right-2 top-2'
